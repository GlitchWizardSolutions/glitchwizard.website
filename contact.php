            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="list-group">
                        <a class="list-group-item list-group-item-action" href="mailto:<?php echo htmlspecialchars($settings['email']); ?>" target="_blank"><i class="fa fa-envelope"></i><span>&nbsp; E-Mail: <strong><?php echo htmlspecialchars($settings['email']); ?></span></strong></a>
                        <?php if (!empty($settings['facebook'])) { ?>
                            <a class="list-group-item list-group-item-primary list-group-item-action" href="<?php echo htmlspecialchars($settings['facebook']); ?>" target="_blank"><strong><i class="fab fa-facebook-square"></i>&nbsp; Facebook</strong></a>
                        <?php } ?>
                        <?php if (!empty($settings['instagram'])) { ?>
                            <a class="list-group-item list-group-item-warning list-group-item-action" href="<?php

                        echo htmlspecialchars($settings['instagram']); ?>" target="_blank"><strong><i class="fab fa-instagram"></i>&nbsp; Instagram</strong></a>
                        <?php } ?>
                        <?php if (!empty($settings['twitter'])) { ?>
                            <a class="list-group-item list-group-item-info list-group-item-action" href="<?php echo htmlspecialchars($settings['twitter']); ?>" target="_blank"><strong><i class="fab fa-twitter-square"></i>&nbsp; Twitter</strong></a>
                        <?php } ?>
                        <?php if (!empty($settings['youtube'])) { ?>
                            <a class="list-group-item list-group-item-danger list-group-item-action" href="<?php echo htmlspecialchars($settings['youtube']); ?>" target="_blank"><strong><i class="fab fa-youtube-square"></i>&nbsp; YouTube</strong></a>
                        <?php } ?>
                        <?php if (!empty($settings['linkedin'])) { ?>
                            <a class="list-group-item list-group-item-primary list-group-item-action" href="<?php echo htmlspecialchars($settings['linkedin']); ?>" target="_blank"><strong><i class="fab fa-linkedin"></i>&nbsp; LinkedIn</strong></a>
                        <?php } ?>
                    </div>
