...
// Load image helper
require_once 'settings/image_helper.php';
...
// Get hero image from centralized config
$hero_bg_image = get_image_path('hero', 'assets/img/hero-bg.jpg');
$hero_alt = get_image_alt('hero', 'Hero Background');
?>
<!-- Hero Section -->
