<?php
/*
 * LEGACY ARCHIVE: Comprehensive Branding Settings - File-Based System
 * 
 * SYSTEM: GWS Universal Hybrid App
 * FILE: branding_settings_legacy_archive.php
 * LOCATION: /public_html/assets/includes/settings/
 * PURPOSE: ARCHIVED - Reference copy of old file-based branding system
 * 
 * NOTE: This file is preserved for reference only. The system now uses
 * database-driven branding managed through the enhanced branding functions.
 * 
 * ARCHIVED: 2025-08-16 13:05:24
 * VERSION: 1.0 (LEGACY)
 */
...
// =========================================================================
// TEMPLATE SELECTION (CSS Color Arrangements) - LEGACY SYSTEM
// =========================================================================
// NOTE: This template system has been replaced by the enhanced multi-area
// database-driven template system. See: branding-templates-enhanced.php

$brand_template_selected = 'template_1';

$brand_templates = [
    'template_1' => [
        'name' => 'Classic',
        'description' => 'Traditional layout with primary color for headers',
        'css_class' => 'brand-template-classic'
    ],
    'template_2' => [
        'name' => 'Modern',
        'description' => 'Contemporary layout with secondary color emphasis',
        'css_class' => 'brand-template-modern'
    ],
    'template_3' => [
        'name' => 'Bold',
        'description' => 'High contrast layout with accent colors',
        'css_class' => 'brand-template-bold'
    ]
];
