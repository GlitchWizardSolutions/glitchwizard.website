...
// Dynamically locate and include public_settings.php
$settings_found = false;
$settings_path = 'public_html/assets/includes/settings/public_settings.php';
for ($i = 0; $i <= $max_levels; $i++) {
...
if (!$settings_found) {
    die('Critical error: Could not locate public_settings.php');
}
...
<head>
  ...
  <link href="assets/css/section-borders.css" rel="stylesheet">
