          ...
          <div class="row gy-4">
            ...
            <div class="col-md-12 text-center">
              ...
              <div class="sent-message" role="status" aria-live="polite" style="display: none;">
                <i class="fas fa-check-circle text-success"></i> Your message has been sent. Thank you!
              </div>
    ...
    form.addEventListener('submit', function(e) {
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                successDiv.innerHTML = '<i class="fas fa-check-circle text-success"></i> ' + data.message;
                form.reset();
                ...
                errorDiv.innerHTML = '<i class="fas fa-exclamation-triangle text-danger"></i> ' + data.message;
        ...
        .catch(error => {
            ...
            loadingDiv.style.display = 'none';
            errorDiv.style.display = 'block';
            errorDiv.innerHTML = '<i class="fas fa-exclamation-triangle text-danger"></i> An error occurred. Please try again.';
        })
        .finally(() => {
            isSubmitting = false;
