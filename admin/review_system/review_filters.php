...
// Table icons for sorting
$table_icons = ['asc' => '<i class="fas fa-sort-up ms-1"></i>', 'desc' => '<i class="fas fa-sort-down ms-1"></i>'];
?>
<?=template_admin_header('Review Filters', 'reviews', 'manage')?>
