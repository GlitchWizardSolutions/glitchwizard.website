...
// Table sorting icons (from accounts.php)
$table_icons = [
    'asc' => ' <i class="fas fa-sort-up text-primary" aria-hidden="true"></i>',
    'desc' => ' <i class="fas fa-sort-down text-primary" aria-hidden="true"></i>'
];
?>
                        ...
                        <td class="text-center d-none d-lg-table-cell">
                            <?php if ($client['total_invoices'] > 0): ?>
                                <a href="invoices.php?client_id=<?=$client['id']?>" class="btn btn-sm btn-outline-primary">
                                    <?=$client['total_invoices']?> <i class="fas fa-external-link-alt ms-1"></i>
                                </a>
                            <?php else: ?>
