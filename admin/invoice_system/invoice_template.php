                ...
                <div class="mb-3">
                                ...
                                <div class="p-3">
                                    ...
                                    <div class="mt-2 d-flex justify-content-between align-items-center">
                                        <small class="text-muted">
                                            <i class="fas fa-keyboard me-1"></i>Press F11 for fullscreen • Ctrl+Space for autocomplete
                                        </small>
                            ...
                            <div class="tab-pane fade" id="pdf-preview" role="tabpanel" aria-labelledby="pdf-preview-tab">
                                <div class="p-3">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <h6 class="mb-0">
                                            <i class="fas fa-eye text-primary me-1"></i>Template Preview
                                        </h6>
                                    ...
                                    <div id="pdf-preview-container" class="border rounded bg-white position-relative" style="min-height: 400px;">
                                        <div class="position-absolute top-50 start-50 translate-middle text-center">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="updatePreview()">
                                                <i class="fas fa-play me-1"></i>Generate Preview
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="form-text mt-2">
                        ...
                        <a href="#" data-bs-toggle="modal" data-bs-target="#pdfInstructionsModal" class="text-decoration-none">
                            <i class="fas fa-info-circle"></i> View instructions and examples
                        </a>
                    </div>
                </div>
            </fieldset>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="pdfInstructionsModalLabel">
                    <i class="fas fa-file-pdf text-danger me-2"></i>PDF Template Instructions
                </h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="loadDefaultTemplate()" data-bs-dismiss="modal">
                    <i class="fas fa-download me-1"></i>Use Sample Template
                </button>
            </div>
        </div>
    </div>
...
function updatePreview() {
    ...
    loadingOverlay.innerHTML = `
        <div class="text-center">
            ...
            <p class="text-muted mb-0">Rendering preview...</p>
        </div>
    `;
