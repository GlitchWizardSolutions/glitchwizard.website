...
<div class="content-title mb-4" id="main-gallery-media" role="banner" aria-label="Gallery Media Management Header">
    <div class="title">
        <div class="icon">
            <svg width="18" height="18" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
...
<div class="mb-4" role="region" aria-label="Success Message">
    <div class="alert alert-success d-flex align-items-center" role="alert">
        <svg width="14" height="14" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="me-2" aria-hidden="true"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209L241 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L335 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z"/></svg>
        <div><?=$success_msg?></div>
    </div>
</div>
<?php endif; ?>
            ...
            <table class="table table-hover mb-0">
                ...
                <tr>
                    <td colspan="9" class="text-center py-4 text-muted">
                        <i class="fas fa-images mb-2" style="font-size: 2rem; opacity: 0.5;"></i>
                        ...
                        <div class="table-dropdown">
                            ...
                            <div class="table-dropdown-items">
                                ...
                                <a href="../<?=$m['filepath']?>" target="_blank" download>
                                    <span class="icon">
                                        <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M2 12H4V17H20V12H22V17C22 18.11 21.11 19 20 19H4C2.9 19 2 18.11 2 17V12M12 15L17.55 9.54L16.13 8.13L13 11.25V2H11V11.25L7.88 8.13L6.46 9.55L12 15Z" /></svg>
                                    </span>    
                                    Download
                                </a>
                                <?php endif; ?>
