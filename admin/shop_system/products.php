...
<div class="content-title" id="main-shop-products" role="banner" aria-label="Shop Products Management Header">
    <div class="title">
        <div class="icon">
                    ...
                    <td class="actions">
                        <div class="table-dropdown">
                            ...
                            <div class="table-dropdown-items">
                                ...
                                <a class="red" href="products.php?delete=<?=$product['id']?>" onclick="return confirm('Are you sure you want to delete this product?')">>
                                    <span class="icon">
