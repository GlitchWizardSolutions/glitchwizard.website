...
<body>
    <div class="container-fluid mt-4">
        <div class="row">
            <div class="col-12">
                <h1><i class="fas fa-shield-alt text-primary"></i> Safe Content Integration Manager</h1>
                <p class="text-muted">Preview, verify, and safely integrate hardcoded content with settings system</p>
                
                <!-- Safety Status Panel -->
                <div class="safe-zone mb-4">
                    <h5><i class="fas fa-check-circle text-success"></i> Safety Features Active</h5>
                    <ul class="mb-0">
                ...
                <div class="card mt-4">
                    <div class="card-header">
                        <h5><i class="fas fa-history"></i> Recent Integrations</h5>
                    </div>
                    <div class="card-body">
                ...
                if (data.success) {
                    ...
                    item.innerHTML = `
                        <div class="alert alert-success">
                            <h6><i class="fas fa-check-circle"></i> Integration Successful!</h6>
                            <p>${data.message}</p>
...
function extract_existing_variables() {
    $vars = [];
    $settings_file = "../assets/includes/settings/public_settings.php";
...
function display_integration_preview($item, $index, $page_name) {
    ...
    <div class="integration-item" id="item_<?php echo $integration_id; ?>">
        <div class="d-flex justify-content-between align-items-start mb-3">
            <h6><i class="fas fa-code"></i> Integration Preview #<?php echo $index + 1; ?></h6>
            <div>
        ...
        <form method="POST" id="form_<?php echo $integration_id; ?>">
            ...
            <div class="d-flex gap-2 mt-3">
                ...
                <button type="button" class="btn btn-outline-secondary" onclick="editVariableName('<?php echo $integration_id; ?>')">
                    <i class="fas fa-edit"></i> Edit Variable Name
                </button>
            </div>
        </form>
    </div>
