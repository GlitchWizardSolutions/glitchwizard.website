<?php
/**
 * Account Roles Management System
 * 
 * SYSTEM: GWS Universal Hybrid App - Admin Panel
 * FILE: roles.php
 * LOCATION: /public_html/admin/accounts/
 * PURPOSE: Display account role statistics and counts for active/inactive users
 * 
 * CREATED: 2025-07-04
 * UPDATED: 2025-07-22
 * VERSION: 1.1
 ...
 * 
 * CHANGE LOG:
 * 2025-07-04 - Initial creation with role statistics display
 * 2025-07-04 - Added bold/centered styling for data columns
...
?>
<?= template_admin_header('Account Roles', 'accounts', 'roles') ?>

<style>
    /* Make data columns bold and centered in roles table */
...
<div class="card">
    <h6 class="card-header">Account Roles</h6>
    <div class="card-body">
        <div class="table">
            ...
            <tbody>
                ...
                <?php foreach ($roles as $k => $v): ?>
                    <tr>
                        ...
                        <td><a href="accounts.php?role=<?= $k ?>&last_seen=month"
                                class="link1"><?= number_format(isset($roles_active[$k]) ? $roles_active[$k] : 0) ?></a>
                        </td>
                        <td><a href="accounts.php?role=<?= $k ?>&last_seen=inactive"
                                class="link1"><?= number_format(isset($roles_inactive[$k]) ? $roles_inactive[$k] : 0) ?></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
