...
<div class="mb-4">
                ...
                <div>
                    <?php if ($viewing_specific_account): ?>
                        <a href="documents.php" class="btn btn-outline-secondary me-2">
                            <i class="fas fa-arrow-left me-1"></i> All Folders
                        </a>
                    ...
                    <?php else: ?>
                        <a href="accounts.php" class="btn btn-outline-secondary">
                            <i class="fas fa-users me-1"></i> Back to Accounts
                        </a>
                    <?php endif; ?>
                </div>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <?php else: ?>
                                        ...
                                        ?>
                                        <i class="fas <?= $icon_class ?> <?= $icon_color ?>"></i>
                                    <?php endif; ?>
                                </td>
                                <td>
    ...
    <div class="card mt-3">
        <div class="card-body">
            <h6 class="card-title">
                <i class="fas fa-shield-alt me-2"></i>Access Information
            </h6>
            <div class="row">
                <div class="col-md-4">
