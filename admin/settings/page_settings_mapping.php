...
return [
    ...
    'services.php' => [
        'settings_files' => [
            'general_content_settings.php' => [
                'path' => '../../assets/includes/settings/general_content_settings.php',
                'type' => 'php_variables',
                'variables' => [
                    'services_content' => [
                        'title' => ['type' => 'text', 'label' => 'Services Title'],
                        'description' => ['type' => 'summernote', 'label' => 'Services Description'],
                        'featured_services' => ['type' => 'summernote', 'label' => 'Featured Services']
                    ]
                ]
            ]
        ],
