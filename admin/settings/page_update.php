...
?>
<?php echo template_admin_header('Page Settings - ' . $display_name); ?>
        ...
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 mb-0 text-gray-800">
                    <i class="fas fa-edit"></i>&nbsp;&nbsp;<?php echo htmlspecialchars($display_name); ?> Settings
                </h1>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">
                        <i class="fas fa-cogs"></i>&nbsp;&nbsp;Configure <?php echo htmlspecialchars($display_name); ?>
                    </h6>
                </div>
                <div class="card-body">
                    ...
                    <div class="alert alert-info">
                        <h5><i class="fas fa-info-circle"></i>&nbsp;&nbsp;Page Settings Setup Required</h5>
                    ...
                    <form method="POST" id="setupPageForm">
                        ...
                        <div class="d-flex justify-content-between">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-plus"></i>&nbsp;&nbsp;Create Page Settings
                            </button>
                    ...
                    <div class="alert alert-warning">
                        <h5><i class="fas fa-exclamation-triangle"></i>&nbsp;&nbsp;No Settings Available</h5>
                        ...
                        <div class="mt-3">
                            <a href="settings_dash.php" class="btn btn-primary">
                                <i class="fas fa-cogs"></i>&nbsp;&nbsp;Back to Settings Dashboard
                            </a>
                        </div>
                    </div>
                    <?php else: ?>
                    ...
                    <form method="POST" id="pageSettingsForm">
                        ...
                        <div class="mb-4">
                            <h5 class="text-primary border-bottom pb-2">
                                <i class="fas fa-folder"></i>&nbsp;&nbsp;<?php echo ucwords(str_replace('_', ' ', $var_name)); ?>
                            </h5>
                            <?php 
                        ...
                        <div class="mb-4">
                            <h5 class="text-primary border-bottom pb-2">
                                <i class="fas fa-image"></i>&nbsp;&nbsp;<?php echo ucwords(str_replace('_', ' ', $image_key)); ?> Image
                            </h5>
                            <?php 
