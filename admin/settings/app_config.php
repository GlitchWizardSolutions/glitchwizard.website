...
?>
<?php echo template_admin_header('App Configuration - ' . $display_name); ?>
        ...
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 mb-0 text-gray-800">
                    <i class="fas fa-cogs"></i>&nbsp;&nbsp;<?php echo htmlspecialchars($display_name); ?> Configuration
                </h1>
            ...
            <div class="alert alert-info">
                <h6><i class="fas fa-info-circle"></i> About This Configuration</h6>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">
                            <i class="<?php echo $section['icon']; ?>"></i>&nbsp;&nbsp;<?php echo $section['title']; ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <small class="text-muted">
                                    <i class="fas fa-shield-alt"></i> A backup will be created automatically
                                </small>
                            </div>
                        </div>
                    </div>
