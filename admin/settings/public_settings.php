...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $settings_code .= "// Branding\n";
    $settings_code .= "\$brand_primary_color = '" . addslashes((isset($new_settings['brand_primary_color']) && trim($new_settings['brand_primary_color']) !== '') ? $new_settings['brand_primary_color'] : ($brand_primary_color ?? '')) . "';\n";
    $settings_code .= "\$brand_secondary_color = '" . addslashes((isset($new_settings['brand_secondary_color']) && trim($new_settings['brand_secondary_color']) !== '') ? $new_settings['brand_secondary_color'] : ($brand_secondary_color ?? '')) . "';\n";
    $settings_code .= "\$brand_font_family = '" . addslashes((isset($new_settings['brand_font_family']) && trim($new_settings['brand_font_family']) !== '') ? $new_settings['brand_font_family'] : ($brand_font_family ?? '')) . "';\n\n";
        ...
        <div class="form-section col-12">
            ...
            <div class="row mb-2 align-items-center">
                <div class="col-md-4">
                    ...
                    <input type="text" name="brand_primary_color" class="form-control w-75 d-inline-block"
                        style="max-width: 120px; display: inline-block; font-size: 16px;"
                        value="<?php echo htmlspecialchars($brand_primary_color); ?>">
                </div>
                <div class="col-md-8">
                    <span class="text-muted ms-2">Affects: Accent elements (buttons, links, highlights), main brand
                        color throughout the site.</span>
                </div>
            </div>
            <div class="row mb-2 align-items-center">
                <div class="col-md-4">
                    <label class="form-label">Secondary Color</label>
                    <input type="text" name="brand_secondary_color" class="form-control w-75 d-inline-block"
                        style="max-width: 120px; display: inline-block; font-size: 16px;"
                        value="<?php echo htmlspecialchars($brand_secondary_color); ?>">
                </div>
                <div class="col-md-8">
                    <span class="text-muted ms-2">Affects: Headings, section titles, and secondary highlights.</span>
                </div>
            </div>
            <div class="row mb-2 align-items-center">
                <div class="col-md-4">
                    <label class="form-label">Font Family</label>
                    <input type="text" name="brand_font_family" class="form-control w-75 d-inline-block"
                        style="max-width: 180px; display: inline-block; font-size: 16px;"
                        value="<?php echo htmlspecialchars($brand_font_family); ?>">
                </div>
                <div class="col-md-8">
                    <span class="text-muted ms-2">Affects: All headings and body text site-wide.</span>
                </div>
            </div>
        </div>
        <div class="form-section col-12">
