    ...
    <div class="title">
        <div class="icon">
            <svg width="18" height="18" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                <path d="M345.9 70.9c-9.9-9.9-24.3-9.9-34.2 0L288 94.6l-67.9-67.9c-9.9-9.9-24.3-9.9-34.2 0L163.1 49.4c-9.9 9.9-9.9 24.3 0 34.2L196.9 117.3c9.9 9.9 24.3 9.9 34.2 0L288 60.4l56.9 56.9c9.9 9.9 24.3 9.9 34.2 0L401.9 94.6c9.9-9.9 9.9-24.3 0-34.2L345.9 70.9zM48 128C21.5 128 0 149.5 0 176V336c0 26.5 21.5 48 48 48H98.7c-7.4-10.8-9.7-24.3-5.8-37.1l58.9-196.9c4.8-16.1 19.7-27 36.6-27h85.3c16.9 0 31.8 10.9 36.6 27l58.9 196.9c3.9 12.8 1.6 26.3-5.8 37.1H464c26.5 0 48-21.5 48-48V176c0-26.5-21.5-48-48-48H48z"/>
            </svg>
        </div>
        <div class="txt">
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-3 mb-2">
                    <a href="<?=$upload['filepath']?>" target="_blank" class="btn btn-outline-secondary btn-sm">
                        <i class="fas fa-file"></i> <?=basename($upload['filepath'])?>
                    </a>
                </div>
                <?php endforeach; ?>
            </div>
