...
<div class="mb-3">
	<a href="menu_editor.php" class="btn btn-outline-secondary" aria-label="Cancel and return to menu editor">
	...
	<div class="card-body">
		<form action="" method="post">
			...
			<div class="form-actions d-flex justify-content-start">
				<button type="submit" name="add" class="btn btn-success" aria-label="Save menu item">
