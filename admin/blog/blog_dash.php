...
<div class="content-title mb-4" id="main-blog-dashboard" role="banner" aria-label="Blog Dashboard Header">
    <div class="title">
        <div class="icon">
        ...
        <div class="txt">
            ...
            <p>Maintenance of the entire Blog System.</p>
        </div>
    </div>
</div>
...
<div class="dashboard-apps">
    ...
    <div class="app-card" role="region" aria-labelledby="content-title">
        <div class="app-header accounts-header" role="banner" aria-labelledby="content-title">
            <h3 id="content-title">Content Overview</h3>
            <i class="fas fa-newspaper header-icon" aria-hidden="true"></i>
    ...
    <div class="app-card" role="region" aria-labelledby="engagement-title">
        <div class="app-header documents-header" role="banner" aria-labelledby="engagement-title">
            ...
            <span class="badge" aria-label="<?= $total_comments_count ?> total comments"><?= $total_comments_count ?> comments</span>
        </div>
        <div class="app-body">
            <div class="stats-grid">
                <div class="stat-item">
                    ...
                    <div class="stat-progress">
                        <div class="progress-bar success" style="width: <?= $total_comments_count > 0 ? round(($approved_comments_count / $total_comments_count) * 100) : 0 ?>%"></div>
                    </div>
                </div>
                <div class="stat-item">
                ...
                <?php if ($most_commented_post): ?>
                <div class="stat-item full-width">
                    <div class="stat-value"><?= $most_commented_post['comment_count'] ?> comments</div>
                    <div class="stat-label">Most Popular: <?= htmlspecialchars(substr($most_commented_post['title'], 0, 30)) ?><?= strlen($most_commented_post['title']) > 30 ? '...' : '' ?></div>
                </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <!-- Media & Assets Card -->
    <div class="app-card" role="region" aria-labelledby="media-title">
        <div class="app-header client-header" role="banner" aria-labelledby="media-title">
            <h3 id="media-title">Media & Assets</h3>
            <i class="fas fa-folder-open header-icon" aria-hidden="true"></i>
            <span class="badge" aria-label="<?= ($images_count + $documents_count) ?> total files"><?= ($images_count + $documents_count) ?> files</span>
        </div>
        <div class="app-body">
            <div class="stats-grid">
                <div class="stat-item">
                ...
                <div class="stat-item">
                    <div class="stat-value"><?= number_format($albums_count) ?></div>
                ...
                <div class="stat-item">
                    <div class="stat-value"><?= number_format($widgets_count) ?></div>
