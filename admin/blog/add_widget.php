...
<div class="content-title" aria-label="Widgets Management">
	<div class="title">
		<div class="icon">
...
<br <div class="mb-3">
<a href="widgets.php" class="btn btn-outline-secondary" aria-label="Cancel and return to widgets list">
...
<div class="card">
	...
	<div class="card-body">
		<form action="" method="post" aria-label="Add Widget Form" role="form">
			...
			<button type="submit" name="add" class="btn btn-success"> Save Widget</button>
		</form>
	</div>
</div>
