...
<div class="content-title mb-4">
    <div class="title">
        ...
        <div class="txt">
            ...
            <p>Create, edit, and manage all blog posts with rich content editing and media uploads.</p>
        </div>
    </div>
</div>
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h6 class="mb-0">Blog Post Management</h6>
        <small class="text-muted"><?=number_format($total_posts)?> total posts</small>
    </div>
    <div class="card-body">
