        ...
        <div id='3' class="col-md-12">
            ...
            <div id='4' class="card-body">
                ...
                <div id='posted-by-row' class="d-flex justify-content-between align-items-center" aria-label="Post meta information">
                    ...
                    <small>
                        <i class="fa fa-eye"></i> Views <?= $row['views'] ?>
                    </small>
                ...
                <h5><i class="fas fa-share-alt-square"></i> <span aria-label="Share this post">Share</span></h5>
                ...
                {// Display the form, if comments are allowd for the user.
                    ...
                    <form id="comment_form" name="comment_form" action="post.php?name=<?= $post_slug; ?>" method="post" aria-label="Leave a comment">
                        ...
                        <?php endif; ?>
                        <label for="comment"><i class="fa fa-comment"></i> Comment:</label><br>
...
<script>
    if (typeof $ !== 'undefined' && typeof $.fn.jsSocials === 'function') {
        $("#share").jsSocials({
            ...
            showLabel: true,
            shares: [
                { share: "facebook", logo: "fab fa-facebook-square", label: "Share", ariaLabel: "Share on Facebook" },
                { share: "twitter", logo: "fab fa-twitter-square", label: "Tweet", ariaLabel: "Share on Twitter" },
                { share: "linkedin", logo: "fab fa-linkedin", label: "Share", ariaLabel: "Share on LinkedIn" },
                { share: "email", logo: "fas fa-envelope", label: "E-Mail", ariaLabel: "Share via Email" }
            ]
        });
    }
</script>
