      ...
      <div class="col-lg-12 content" data-aos="fade-up" data-aos-delay="100">
        <div class="section-content-box">
          ...
          <div class="content">
            ...
            <div class="row">
              <div class="col-md-6">
                <h5><i class="fas fa-shopping-cart text-primary"></i> Online Store</h5>
              ...
              <div class="col-md-6">
                <h5><i class="fas fa-credit-card text-primary"></i> Payment Terms</h5>
            ...
            <div class="alert alert-info mt-5" role="alert">
              <h4 class="alert-heading"><i class="fas fa-envelope"></i> Questions About Terms of Service?</h4>
              <p>
