...
<div class="container">
    <div class="row">
        <div class="col-md-8 mb-3">
            <div class="card">
                <div class="card-header accent-background"><i class="far fa-file-alt"></i> Blog Posts</div>
                <div class="card-body">
                    <?php
                    $postsperpage = 8;
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                return 'Posted by <b><i class="fas fa-user"></i> ' . $author_username . '</b> on <b><i class="far fa-calendar-alt"></i> ' . date($settings['date_format'], strtotime($row['date'])) . ', ' . htmlspecialchars($row['time']) . '</b>';
