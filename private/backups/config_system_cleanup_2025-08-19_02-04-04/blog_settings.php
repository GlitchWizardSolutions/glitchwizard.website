 ...
 * PURPOSE: Unified blog settings management with tabbed interface
 * DETAILED DESCRIPTION:
 * This file provides a comprehensive interface for managing all blog-related settings
 * across the application. It allows administrators to configure content settings,
 * comment systems, display options, and SEO parameters through an organized
 * tabbed interface.
 * REQUIRED FILES: 
 * - /public_html/assets/includes/settings/blog_content_settings.php
 * - /public_html/assets/includes/settings/blog_comments_settings.php
 * - /public_html/assets/includes/settings/blog_display_settings.php
 * - /public_html/assets/includes/settings/blog_seo_settings.php
 * CREATED: 2025-08-07
 * UPDATED: 2025-08-07
 * VERSION: 1.0
 ...
 * 
 * FEATURES:
 * - Unified tabbed interface for all blog settings
 * - Content tab (post and page settings)
 * - Comments tab (comment system settings)
 * - Display tab (theme and layout settings)
 * - SEO tab (meta tags and sitemap settings)
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Get the active tab from URL hash or default to content
    var activeTabId = window.location.hash ? window.location.hash.substring(1) : 'content';
