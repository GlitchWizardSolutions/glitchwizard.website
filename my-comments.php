...
<div class="container<?php echo ($settings['layout'] == 'Wide') ? '-fluid' : ''; ?> mt-3 mb-5">
	<div class="row">
		...
		<div class="col-md-8 order-2 order-md-2 mb-3">
			<?php
			renderCard('My Comments', 'fa fa-comments');
			?>
					<?php
					if ($logged == 'No') {
										...
										<div class="col-md-12">
											<div class="card-body">
												<h6 class="card-title">
													<div class="row">
														<div class="col-md-10">
															<i class="fas fa-newspaper"></i> On post: <a href="post.php?name=' . htmlspecialchars(post_slug($comment['post_id'])) . '#comments">' . htmlspecialchars(post_title($comment['post_id']))  . '</a>
														</div>
