...
<div class="container<?php echo ($settings['layout'] == 'Wide') ? '-fluid' : ''; ?> mt-3 mb-5">
    <div class="row">
        <div class="col-md-8 order-2 order-md-1 mb-3">
            <div class="card">
                <div class="card-header"><i class="fa fa-images"></i> Gallery
                    <?php
                    // Show filter summary
                    $active_filters = [];
                        ...
                        <div class="row g-2 align-items-center">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <a href="gallery.php" class="btn btn-light btn-sm px-3 d-flex justify-content-center align-items-center" title="Clear Filters" style="margin-right:4px;"><i class="fas fa-times me-2"></i> <span>Clear Filters</span></a>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                                    ...
                                                    <a href="https://www.facebook.com/sharer/sharer.php?u=' . $shareUrl . '" target="_blank" class="btn btn-sm btn-outline-primary" title="Share on Facebook"><i class="fab fa-facebook"></i> Facebook</a>
                                                    <a href="https://twitter.com/intent/tweet?url=' . $shareUrl . '&text=' . $shareText . '" target="_blank" class="btn btn-sm btn-outline-info" title="Share on Twitter"><i class="fab fa-twitter"></i> Twitter</a>
                                                    <a href="https://wa.me/?text=' . $shareText . '%20' . $shareUrl . '" target="_blank" class="btn btn-sm btn-outline-success" title="Share on WhatsApp"><i class="fab fa-whatsapp"></i> WhatsApp</a>
                                                    <a href="mailto:?subject=' . $shareText . '&body=' . $shareUrl . '" class="btn btn-sm btn-outline-secondary" title="Share by Email"><i class="fas fa-envelope"></i> Email</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
