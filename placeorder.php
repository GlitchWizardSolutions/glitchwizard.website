        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header accent-background text-center">
                    <h4 class="mb-0"><i class="fas fa-credit-card"></i> Complete Your Order</h4>
                </div>
                <div class="card-body">
                    <!-- Order Summary -->
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            <h5><i class="fas fa-receipt"></i> Order Total</h5>
                        ...
                        <div class="col-md-8 mx-auto">
                            ...
                            <div class="card mb-3">
                                <div class="card-body text-center">
                                    <h6><i class="fab fa-paypal text-primary"></i> Pay with PayPal</h6>
                                    ...
                                    <?php if (defined('paypal_enabled') && paypal_enabled): ?>
                                        ...
                                        <form action="<?=$paypal_url?>" method="post" id="paypal-form">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-lg">
                                                <i class="fab fa-paypal"></i> Pay with PayPal - <?=currency_code?><?=num_format($total, 2)?>
                                            </button>
                                        </form>
                                    <?php else: ?>
                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    <h6><i class="fas fa-credit-card"></i> Other Payment Options</h6>
                                    <p class="text-muted">Additional payment methods will be available soon.</p>
                                    <button class="btn btn-outline-secondary" disabled>
                                        <i class="fab fa-cc-stripe"></i> Stripe (Coming Soon)
                                    </button>
                                </div>
                            </div>
