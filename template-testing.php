...
<body>
    ...
    <div class="area-switcher">
        <div class="dropdown">
            <button class="btn btn-primary dropdown-toggle" type="button" data-bs-toggle="dropdown">
                <i class="bi bi-layers me-2" aria-hidden="true"></i>Current Area: <?= ucfirst($testArea) ?>
            </button>
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="?test_area=public&test_template=<?= $testTemplate ?>">
                    <i class="bi bi-globe me-2" aria-hidden="true"></i>Public Website
                </a></li>
                <li><a class="dropdown-item" href="?test_area=admin&test_template=<?= $testTemplate ?>">
                    <i class="bi bi-gear-fill me-2" aria-hidden="true"></i>Admin Interface
                </a></li>
                <li><a class="dropdown-item" href="?test_area=client_portal&test_template=<?= $testTemplate ?>">
                    <i class="bi bi-people-fill me-2" aria-hidden="true"></i>Client Portal
                </a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="template-switcher">
        <div class="dropdown dropup">
            <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown">
                <i class="bi bi-palette-fill me-2" aria-hidden="true"></i>Template: <?= ucfirst($testTemplate ?? 'Current') ?>
            </button>
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="?test_area=<?= $testArea ?>&test_template=default">
                    <i class="bi bi-circle-fill me-2" aria-hidden="true"></i>Default
                </a></li>
                <li><a class="dropdown-item" href="?test_area=<?= $testArea ?>&test_template=high-contrast">
                    <i class="bi bi-circle-half me-2" aria-hidden="true"></i>High Contrast
                </a></li>
                <li><a class="dropdown-item" href="?test_area=<?= $testArea ?>&test_template=subtle">
                    <i class="bi bi-dash me-2" aria-hidden="true"></i>Subtle
                </a></li>
                <li><a class="dropdown-item" href="?test_area=<?= $testArea ?>&test_template=bold">
                    <i class="bi bi-plus me-2" aria-hidden="true"></i>Bold
                </a></li>
                <li><a class="dropdown-item" href="?test_area=<?= $testArea ?>&test_template=casual">
                    <i class="bi bi-emoji-smile me-2" aria-hidden="true"></i>Casual
                </a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item" href="?test_area=<?= $testArea ?>">
                    <i class="bi bi-arrow-counterclockwise me-2" aria-hidden="true"></i>Current Active
                </a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="container mt-4">
        <h1 class="mb-4">
            <i class="bi bi-beaker me-2" aria-hidden="true"></i>Enhanced Branding System - Template Testing
        </h1>
        
        <!-- Current Status -->
        <div class="alert alert-info">
            <h5><i class="bi bi-info-circle me-2" aria-hidden="true"></i>Current Configuration</h5>
            <div class="row">
                <div class="col-md-6">
        ...
        <div class="template-demo-section">
            ...
            <div class="alert alert-success" role="alert">
                <i class="bi bi-check-circle me-2" aria-hidden="true"></i>This is a success alert with template styling!
            </div>
            <div class="alert alert-warning" role="alert">
                <i class="bi bi-exclamation-triangle me-2" aria-hidden="true"></i>This is a warning alert with template styling!
            </div>
            <div class="alert alert-danger" role="alert">
                <i class="bi bi-x-circle me-2" aria-hidden="true"></i>This is a danger alert with template styling!
            </div>
            <div class="alert alert-info" role="alert">
                <i class="bi bi-info-circle me-2" aria-hidden="true"></i>This is an info alert with template styling!
            </div>
        </div>
        ...
        <div class="template-demo-section">
            ...
            <div class="d-flex gap-2 flex-wrap">
                <a href="public_html/admin/settings/branding-templates-enhanced.php" class="btn btn-primary">
                    <i class="bi bi-gear-fill me-2" aria-hidden="true"></i>Enhanced Template Manager
                </a>
                <a href="setup-enhanced-branding-system.php" class="btn btn-info">
                    <i class="bi bi-tools me-2" aria-hidden="true"></i>Run Setup
                </a>
                <a href="?test_area=<?= $testArea ?>" class="btn btn-secondary">
                    <i class="bi bi-arrow-counterclockwise me-2" aria-hidden="true"></i>Reset to Active Template
                </a>
            </div>
        </div>
    </div>
