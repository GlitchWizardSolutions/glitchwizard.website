...
<div class="container">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body text-center py-5">
                    <h1 class="display-4 mb-3"><i class="fas fa-store"></i> Welcome to Our Shop</h1>
    ...
    <?php if ($categories): ?>
        <div class="row mb-5">
            <div class="col-12">
                <h2 class="text-center mb-4"><i class="fas fa-tags"></i> Shop by Category</h2>
                <div class="row">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card bg-light">
                <div class="card-body text-center py-5">
                    <h3><i class="fas fa-gift"></i> Start Shopping Today!</h3>
