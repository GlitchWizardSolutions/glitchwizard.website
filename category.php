...
echo '<div class="card">';
echo '<div class="card-header"><i class="far fa-file-alt"></i> Blog - ' . htmlspecialchars($rw['category']) . '</div>';
...
if (!$posts) {
    ...
    foreach ($posts as $row) {
        ...
        echo '          <span class="me-2"><i class="fas fa-eye"></i> Views <b>' . htmlspecialchars($row['views']) . '</b></span>';
        echo '          <span class="me-2"><i class="fas fa-comments"></i> Comments <b>' . htmlspecialchars(post_commentscount($row['id'])) . '</b></span>';
        echo '        </div>';
    ...
    if ($pageNum > 1) {
        $page = $pageNum - 1;
        $previous = "<a href='category.php?name=" . urlencode($slug) . "&page=$page' class='btn btn-default'><i class='fa fa-arrow-left'></i> Previous</a> ";
    ...
    if ($pageNum < $maxPage) {
        $page = $pageNum + 1;
        $next = "<a href='category.php?name=" . urlencode($slug) . "&page=$page' class='btn btn-default'><i class='fa fa-arrow-right'></i> Next</a> ";
