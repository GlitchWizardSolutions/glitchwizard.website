      ...
      <div class="col-lg-12 content" data-aos="fade-up" data-aos-delay="100">
        <div class="section-content-box">
                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h5><i class="fas fa-image text-primary"></i> Alternative Text</h5>
                                ...
                                <h5><i class="fas fa-keyboard text-primary"></i> Keyboard Navigation</h5>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <h5 class="card-title"><i class="fas fa-search text-success"></i> Regular Audits</h5>
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <h5 class="card-title"><i class="fas fa-graduation-cap text-info"></i> Training & Awareness</h5>
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <h5 class="card-title"><i class="fas fa-comments text-warning"></i> User Feedback</h5>
                        ...
                        <div class="alert alert-primary mt-5" role="alert">
                            <h4 class="alert-heading"><i class="fas fa-envelope"></i> Need Accessibility Assistance?</h4>
                            <p>
