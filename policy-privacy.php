        ...
        <div class="section-content-box">
          ...
          <div class="content">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <h5><i class="fas fa-globe text-primary"></i> Automatically Collected Information</h5>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="card mb-3">
                  <div class="card-body">
                    <h6 class="card-title"><i class="fas fa-cog text-success"></i> Service Provision</h6>
              ...
              <div class="col-md-4">
                <div class="card mb-3">
                  <div class="card-body">
                    <h6 class="card-title"><i class="fas fa-envelope text-info"></i> Communication</h6>
              ...
              <div class="col-md-4">
                <div class="card mb-3">
                  <div class="card-body">
                    <h6 class="card-title"><i class="fas fa-chart-line text-warning"></i> Improvement</h6>
            ...
            <div class="alert alert-warning mt-5" role="alert">
              <h4 class="alert-heading"><i class="fas fa-user-shield"></i> Data Deletion Request</h4>
              <p>
            ...
            <div class="alert alert-info mt-3" role="alert">
              <h4 class="alert-heading"><i class="fas fa-envelope"></i> Privacy Questions?</h4>
              <p>
