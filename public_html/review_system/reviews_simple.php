<?php
/*
PAGE NAME  : reviews_simple.php
LOCATION   : public_html/review_system/reviews_simple.php
DESCRIPTION: Review system AJAX endpoint using simplified configuration.
FUNCTION   : Handle review operations and return HTML fragments for AJAX requests.
CHANGE LOG : 2025-08-12 - Created for troubleshooting integration issues
*/

// Include the simple review system config file
...
// Simple test output for troubleshooting
if (!isset($_GET['page_id'])) {
    exit('Please provide the page ID.');
}

echo "Review system is working! Page ID: " . htmlspecialchars($_GET['page_id']);
?>
