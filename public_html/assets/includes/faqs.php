<?php
// FAQs data should be loaded from database_settings.php via doctype.php
// Fallback for missing FAQs data
if (!isset($faqs_title)) {
  $faqs_title = 'Frequently Asked Questions';
}
if (!isset($faqs_paragraph)) {
  $faqs_paragraph = 'Find answers to common questions about our services and platform.';
}
