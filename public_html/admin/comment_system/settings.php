...
function format_key($key) {
    $key = str_replace(
        ['_', 'url', 'db ', ' pass', ' user', ' id', ' uri', 'smtp', 'paypal', 'ipn', 'pdf', 'ajax', 'svg', 'png', 'exif', 'oauth'], 
        [' ', 'URL', 'Database ', ' Password', ' Username', ' ID', ' URI', 'SMTP', 'PayPal', 'IPN', 'PDF', 'AJAX', 'SVG', 'PNG', 'EXIF', 'OAuth'], 
        strtolower($key)
    );
    return ucwords($key);
}
...
?>
<?=template_admin_header('Settings', 'comments', 'settings')?>
...
<form method="post">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Comment System Settings</h5>
        </div>
        <div class="card-body">
