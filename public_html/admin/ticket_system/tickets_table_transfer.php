<?php
/* 
 * Ticket Table Transfer System
 * 
 * SYSTEM: GWS Universal Hybrid App - Admin Panel
 * FILE: tickets_table_transfer.php
 * LOCATION: /public_html/admin/ticket_system/
 * PURPOSE: Import and export ticket data in multiple formats (CSV, JSON, XML, TXT)
 * 
 * FILE RELATIONSHIP:
...
?>
<?= template_admin_header('Import/Export Tickets', 'tickets', 'transfer') ?>
...
<div class="content-title mb-4">
    <div class="title">
        ...
        <div class="txt">
            <h2>Import/Export Tickets</h2>
            <p>Import ticket data from files or export existing tickets to various formats.</p>
        </div>
    </div>
</div>
...
<div class="card">
    ...
    <div class="card-body" style="padding: 0;">
            <!-- Tab Navigation -->
            <div class="tab-nav" role="tablist" aria-label="Ticket data transfer options" style="padding: 1rem 1rem 0; background-color: transparent;">
            ...
            <div id="export-tab" 
                ...
                <form action="" method="post" role="form" aria-labelledby="export-title" id="export-form">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h3 id="export-title">Export Ticket Data</h3>
                            <p id="export-desc">Download all ticket data in your preferred format.</p>
            ...
            <div id="import-tab" 
                ...
                <form action="" method="post" enctype="multipart/form-data" role="form" aria-labelledby="import-title" id="import-form">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h3 id="import-title">Import Ticket Data</h3>
                            <p id="import-desc">Upload a file containing ticket data to import into the system.</p>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div id="import-file-desc" class="form-text">Select a CSV, TXT, JSON, or XML file containing ticket data.</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="file-info" role="region" aria-labelledby="import-formats">
                                ...
                                <ul>
                                    ...
                                    <li><strong>JSON:</strong> Array format with ticket objects</li>
                                    <li><strong>XML:</strong> Valid XML structure with ticket nodes</li>
    ...
    function openTab(evt, tabName) {
        ...
        if (topActionButton) {
            ...
            if (tabName === 'import-tab') {
                ...
                if (buttonIcon) buttonIcon.className = 'bi bi-upload me-1';
                ...
                if (buttonIcon) buttonIcon.className = 'bi bi-download me-1';
