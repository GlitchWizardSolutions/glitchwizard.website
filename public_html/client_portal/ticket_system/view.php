...
<div class="content view">
    ...
    <div class="comments">
        ...
        <div class="comment">
            <div>
                <i class="bi bi-chat-square-text fa-2x" aria-hidden="true"></i>
            </div>
            <p>
                <span class="comment-header">
                    ...
                    <?php if (isset($_SESSION['account_loggedin']) && $_SESSION['account_role'] == 'Admin'): ?>
                    <a href="admin/comment.php?id=<?=$comment['id']?>" target="_blank" class="edit"><i class="bi bi-pencil fa-xs" aria-hidden="true"></i></a>
                    <?php endif; ?>
                </span>
        ...
        <form action="" method="post" class="responsive-width-100">
            <div class="msg">
                ...
                <div class="toolbar">
                    <i class="format-btn bi bi-type-bold" data-format="strong" aria-hidden="true"></i>
                    <i class="format-btn bi bi-type-italic" data-format="i" aria-hidden="true"></i>
                    <i class="format-btn bi bi-type-underline" data-format="u" aria-hidden="true"></i>
                </div>
            </div>
